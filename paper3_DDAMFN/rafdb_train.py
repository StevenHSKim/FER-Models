...
def parse_args():
    ...
    parser.add_argument('--gpu', type=str, default='0', help='Assign GPUs by their numbers, e.g., "0,1" for multiple GPUs.')
    ...
    # optimizer
    parser.add_argument('--optimizer', type=str, default='sgd', choices=['adam', 'adamw', 'sgd'], help='Optimizer type')
        ...
        with torch.no_grad():
            ...
            if acc > 0.91 and acc == best_acc:
                torch.save({'iter': epoch,
                            ...
                            os.path.join('/userHome/userhome1/automl_undergraduate/FER_Models/DDAMFN/checkpoints', "rafdb_epoch"+str(epoch)+"_acc"+str(acc)+"_bacc"+str(balanced_acc)+".pth"))
                ...
                plt.savefig(os.path.join('/userHome/userhome1/automl_undergraduate/FER_Models/DDAMFN/checkpoints', "rafdb_epoch"+str(epoch)+"_acc"+str(acc)+"_bacc"+str(balanced_acc)+".png"))
                plt.close()
