...
| FERPlus | 35711 | [Github](https://github.com/Microsoft/FERPlus) | Github 링크에서 `fer2013new.csv`를 다운로드 받고 [FER2013의 이미지셋](https://www.kaggle.com/c/challenges-in-representation-learning-facial-expression-recognition-challenge/data)과 함께 사용 하세요. | [Github](https://github.com/Microsoft/FERPlus) |
